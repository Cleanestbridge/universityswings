...
[search,state,month].forEach(el=>el.addEventListener('input', applyFilters));
clearFilters.addEventListener('click', ()=>{ search.value=''; state.value=''; month.value=''; applyFilters(); });

// Request form (replaces booking)
...
document.addEventListener('click', (e)=>{
  ...
  if(prefillBtn){
    const uni = prefillBtn.getAttribute('data-university');
    const citystate = prefillBtn.getAttribute('data-citystate');
    $('#rUniversity').value = uni;
    $('#rCityState').value = citystate;
...
requestForm.addEventListener('submit', (e)=>{
  ...
  // Save locally so you can see demo submissions if needed
